...
class BacaEdukasiScreen extends StatelessWidget {
  final String data;
  const BacaEdukasiScreen({required this.data, Key? key}) : super(key: key);

  Stream<QuerySnapshot> _getApprovedPosts() {
    return FirebaseFirestore.instance
        .collection('informasi')
        .where('status', isEqualTo: 'approved')
        .where('kategori', isEqualTo: 'Edukasi')
                        ...
                        child: GestureDetector(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => BacaBeritaScreen(
                                        data: 'Baca Berita',
                                      )),
                            );
                          },
