...
class UnggahInfoScreen extends StatefulWidget {
  final String data;
  UnggahInfoScreen({required this.data, super.key});

  @override
  _UnggahInfoScreenState createState() => _UnggahInfoScreenState();
}

class _UnggahInfoScreenState extends State<UnggahInfoScreen> {
